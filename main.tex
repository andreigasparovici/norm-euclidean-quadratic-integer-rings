...
\vspace{.8cm}
Ne propunem să găsim $\theta \in \mathbb{C} \backslash \mathbb{Q}$ pentru care $\mathbb{Z}[\theta]$ este \textbf{euclidian} în raport cu funcţia normă.
\vspace{.8cm}
...
\begin{equation} \label{eq:z_theta_euclidean}
    \begin{split}
	\forall z_1, z_2 \in \mathbb{Z}[\theta], z_2 \neq 0 \quad \exists \, c, r \in \mathbb{Z}[\theta] \quad \text{a.î.} \quad
        & z_1 = z_2 c + r, \text{ cu } N(r) < N(z_2) \\
...
$\mathbb{Z}\left[\frac{1 + i\sqrt{11}}{2}\right]$
